        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="card">
                <div class="card-header">
                    Trabajos de Titulación para anular
                </div>
                ...
                <div class="card-body">
                    ...
                    <div>
                        Busqueda por rut
                        {{ Form::open(['route' => 'anular-trabajo', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                            ...
                            <tr>
                                ...
                                <td width="1px">
                                    {!! Form::open(['route' => ['trabajo.destroy', $trabajo->id], 'method' => 'DELETE']) !!}
                                        <button class="btn btn-danger" onclick="return confirm('¿Seguro que desea eliminar?')">
                                            Anular
                                        </button>                           
                                    {!! Form::close() !!}
                                </td>
