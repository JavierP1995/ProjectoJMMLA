        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Registrar Trabajo de Titulación
                    <td width="100px">
                ...
                @endif
                    {!! Form::open(['route' => 'trabajo.store']) !!}
                        ...
                        @include('admin.actividad.partials.formCrear')
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#organizaciones').hide();
        $('#tutores').hide();
        document.getElementById("tipoActividad_id").value = null;
        $('.estudiante-select-container').empty();
        $('.btn-add-more-estudiante').after(template1);
        cantEstudiantes = 1;
    ...
    $("#tipoActividad_id").change(function(e){
        ...
        $('.tutores').empty();
        $('.estudiante-select-container').remove();
        $('.btn-add-more-estudiante').after(template1);
        cantEstudiantes = 1;
        console.log('asd');
